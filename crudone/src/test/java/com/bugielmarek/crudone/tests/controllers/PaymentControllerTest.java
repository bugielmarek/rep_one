...
import com.bugielmarek.crudone.controllers.PaymentController;
...
public class PaymentControllerTest {
	...
	public void testCreatePayment_POST__ValidPaymentPassed_NonExistingInDB() throws Exception {
		...
		Payment saved = Payment.builder()
				...
				.user(user)
				.build();
		when(mockService.exists(unsaved)).thenReturn(false);
		...
		mockMvc.perform(post("/payments/createpayment")
				...
				;
		verify(mockService, times(1)).exists(unsaved);
	...
	public void testCreatePaymentPOST_ExistingInDB() throws Exception {
		...
		Payment existing = Payment.builder()
				...
				.user(User.builder()
						...
						.build())
				.build();
		when(mockService.exists(unsaved)).thenReturn(true);
