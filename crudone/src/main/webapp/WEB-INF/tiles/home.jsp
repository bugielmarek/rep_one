...
<c:url var="receivedcasefiles" value="/receivedcasefiles/findreceivedcasefile" />
...
<table class="searchTable">
	...
	<sf:form method="post" action="${receivedcasefiles}"
		modelAtribute="formClass" commandName="formClass">
		<tr>
			<td colspan=2 class="cell_2"><spring:message
					code="search.tableRowReceivedCaseFile" /></td>
			<td colspan=2 class="cell_2"><div class="errors_2">
					<sf:errors path="receivedCaseFile.name" />
				</div></td>
		</tr>
		...
		<tr>
			<td colspan=3>
				<ul>
					<li><div class="smallItalic">
							<spring:message code="search.tableRowReceivedCaseFileByName" />
						</div></li>
					<li><sf:input path="receivedCaseFile.name" type="text" /></li>
				</ul>
			</td>
