...
<sec:authorize access="isAuthenticated()">
	<nav>
		<ul>
			...
			<li><a href="<c:url value='receivedcasefiles' />"> <spring:message
						code="header.navbarReceivedCaseFile" /></a>
				<ul>

					<li><a
						href="<c:url value='/receivedcasefiles/createreceivedcasefile' />"><spring:message
								code="header.navbarAddReceivedCaseFile" /> </a></li>
				</ul></li>
